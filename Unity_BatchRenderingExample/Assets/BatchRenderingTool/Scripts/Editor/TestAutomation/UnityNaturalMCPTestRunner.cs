...
namespace BatchRenderingTool.TestAutomation
{
    ...
    public static class UnityNaturalMCPTestRunner
    {
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] テスト実行とレポート生成を開始します");
            ...
            try
            {
                ...
                UnityEngine.Debug.Log("[MCPTestRunner] すべての処理が完了しました");
            }
            catch (Exception e)
            {
                UnityEngine.Debug.LogError($"[MCPTestRunner] エラーが発生しました: {e.Message}\n{e.StackTrace}");
            }
        }
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] Edit Modeテストを実行します");
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] Play Modeテストを実行します");
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] 最新のテスト結果をエクスポートします");
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] Edit Modeテストを実行中...");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] Edit Modeテスト完了 - Pass: {result.passCount}, Fail: {result.failCount}");
            return result;
        }
        
        private static TestRunnerAutomation.TestResult RunPlayModeTests()
        {
            UnityEngine.Debug.Log("[MCPTestRunner] Play Modeテストを実行中...");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] Play Modeテスト完了 - Pass: {result.passCount}, Fail: {result.failCount}");
            return result;
        }
        ...
        private static void GenerateAllReports(List<TestRunnerAutomation.TestResult> results)
        {
            ...
            {
                UnityEngine.Debug.LogWarning("[MCPTestRunner] レポート生成するテスト結果がありません");
                return;
            }
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] HTMLレポート生成: {htmlPath}");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] JSONレポート生成: {jsonPath}");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] Markdownレポート生成: {mdPath}");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] CSVレポート生成: {csvPath}");
        ...
        {
            UnityEngine.Debug.Log("[MCPTestRunner] コンソールログをエクスポート中...");
            ...
            UnityEngine.Debug.Log($"[MCPTestRunner] コンソールログをエクスポート: {logPath}");
        }
        
        private static void ClearConsoleLogs()
        {
            // Unity Natural MCPのclear_console_logsを呼び出すシミュレーション
            UnityEngine.Debug.Log("[MCPTestRunner] コンソールログをクリアしました");
        }
        ...
        private static void OutputTestSummary(List<TestRunnerAutomation.TestResult> results)
        {
            ...
            UnityEngine.Debug.Log("テスト実行サマリー");
            UnityEngine.Debug.Log("========================================");
            UnityEngine.Debug.Log($"総テスト数: {totalTests}");
            UnityEngine.Debug.Log($"成功: {totalPass} ✅");
            UnityEngine.Debug.Log($"失敗: {totalFail} ❌");
            UnityEngine.Debug.Log($"スキップ: {totalSkip} ⏭️");
            UnityEngine.Debug.Log($"成功率: {successRate:F1}%");
            UnityEngine.Debug.Log("========================================");
            
            if (totalFail > 0)
            {
                UnityEngine.Debug.LogError($"⚠️ {totalFail}個のテストが失敗しました。詳細はレポートを確認してください。");
            }
            else
            {
                UnityEngine.Debug.Log("✅ すべてのテストが成功しました！");
            }
        }
        ...
        private static void CreateLatestSymlinks(string timestamp)
        {
            ...
            {
                UnityEngine.Debug.LogWarning($"[MCPTestRunner] シンボリックリンク作成エラー: {e.Message}");
            }
        }
